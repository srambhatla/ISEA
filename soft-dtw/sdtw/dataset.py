...
home = os.path.expanduser("~")
data_dir = os.path.join(home, "/TimeWarping/sdtw_data")
data_dir = home + "/TimeWarping/sdtw_data"
ucr_dir = os.path.join(data_dir, "UCR_Archive_2018")
...
def load_ucr(name):
    ...
    tr = os.path.join(folder, "%s_TRAIN.tsv" % name)
    te = os.path.join(folder, "%s_TEST.tsv" % name)
